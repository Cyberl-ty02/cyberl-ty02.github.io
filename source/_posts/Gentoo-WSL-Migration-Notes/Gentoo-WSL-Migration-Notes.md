...
New-Item -ItemType Directory -Force "D:\VirtualMachine\Wsl\Gentoo"

wsl --import Gentoo "D:\VirtualMachine\Wsl\Gentoo" "D:\Downloads\gentoo.wsl" --version 2
```
...
```bash
ldd /home/lty/.cache/JetBrains/RemoteDev/dist/*/jbr/lib/libawt_wlawt.so | grep "not found"
```
